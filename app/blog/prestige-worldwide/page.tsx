    ...
    content={
      <>
        <p>
          ...
          ambiguous answers to this question, so last week we started writing an{' '}
          <Link
        ...
        <p>
          ...
          encounters we may face throughout the process of developing a game. It
          will also better prepare us for when someone asks what the vision for
          our game is and be useful when we start looking for a publisher and
          marketing our game.
        </p>
        ...
        <p>
          ...
          do not want to reveal until the player experiences them on their own;
          however, we also want to avoid being too vague regarding the gameplay.
          So we began the writing process by making two lists: what we wanted to
          say in our pitch, and what we didn’t want to say. Next, we wrote a few
          draft versions of our pitch, refining and reworking it over time. And
          since most resources around elevator pitches recommend keeping the
          pitch short and sweet (between 30 seconds and 2 minutes long), we’ve
        ...
        <p className="quote">
          Survivors of a societal collapse must go on an epic adventure to find
          a new home. Lead the survivors through a vast wilderness and battle
          fearsome foes while uncovering the mysterious past of your ancestors.
        </p>
