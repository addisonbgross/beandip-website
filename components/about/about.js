...
const About = () => (
  <div>
    <p className={styles.summary}>
      <strong>beandip games</strong> is a Canadian indie game currently studio
      currently working on its first game. We aim to create unique (and slightly
      weird) gaming experiences. Follow along with our development blog as we
      share our creation process in a holistic way.
    </p>
